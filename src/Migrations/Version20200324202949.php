 ...
 */
final class Version20200324202949 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, host_id INT NOT NULL, winner_id INT DEFAULT NULL, number_of_rounds INT NOT NULL, map JSON DEFAULT NULL, words JSON DEFAULT NULL, progress JSON DEFAULT NULL, status INT NOT NULL, INDEX IDX_232B318C1FB8D185 (host_id), UNIQUE INDEX UNIQ_232B318C5DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE round (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, spy_master_1_id INT NOT NULL, spy_master_2_id INT NOT NULL, INDEX IDX_C5EEEA34E48FD905 (game_id), INDEX IDX_C5EEEA34E9F27319 (spy_master_1_id), INDEX IDX_C5EEEA34FB47DCF7 (spy_master_2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE turn (id INT AUTO_INCREMENT NOT NULL, spy_master_id INT NOT NULL, word VARCHAR(255) NOT NULL, number INT NOT NULL, pointed JSON NOT NULL, INDEX IDX_2020154714CAA930 (spy_master_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
